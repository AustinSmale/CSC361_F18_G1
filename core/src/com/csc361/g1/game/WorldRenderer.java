...
public class WorldRenderer implements Disposable {
	...
	private void init() {
		...
		camera.update();
		// initialize the camera gui for our lives, points, and fps
	...
	/**
	 * Render out the GUI that lays overtop of the game to show user game
	 * information
	 * 
	 * @param batch
	 */
	...
	/**
	 * Render the GUI socre on the top left of the screen
	 * 
	 * @param batch
	 */
	...
	/**
	 * Render the Lives a user has on the top right
	 * 
	 * @param batch
	 */
	private void renderGuiExtraLive(SpriteBatch batch) {
		...
		//Visual Effect for when the player loses a life.
